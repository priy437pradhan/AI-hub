...
export const useDesktopSliders = () => {
  ...
  const structureAdjustSliders = [
    { key: 'details', label: 'Details', icon: <Focus size={14} />, color: 'blue', min: -100, max: 100 },
    { key: 'gradient', label: 'Gradient', icon: <Zap size={14} />, color: 'blue', min: -100, max: 100 }
  ];
  ...
  const mosaicAdjustSliders = [
    { 
      key: 'type', 
      label: 'Type', 
      icon: <Grid size={14} />, // Made consistent with other desktop sliders
      color: 'purple', 
      type: 'select',
      options: [
