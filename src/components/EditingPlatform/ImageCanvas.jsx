  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex flex-col relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row flex-1 relative z-10">
        ...
        <div
  className={`flex-1 flex justify-center items-center bg-white/80 backdrop-blur-sm shadow-lg relative overflow-hidden min-h-[60vh] lg:min-h-[calc(100vh-12rem)] 
    ${!imagePreview ? 'border-8 border-dotted border-blue-500 shadow-[0_0_25px_rgba(59,130,246,0.5)]' : ''}`}
  ref={containerRef}
>
            ...
            {imagePreview ? (
              <div className="relative w-full h-full flex items-center justify-center">
                <div className="relative overflow-hidden shadow-l border border-white/20  max-w-full max-h-full">
                  <img
                    src={imagePreview}
                    alt="Preview"
                    ref={imageRef}
                ...
                {cropSettings?.isActive && (
                  <div
                    className={`absolute border-2 border-blue-500 bg-blue-500/10 backdrop-blur-sm ${
                      isDragging
                        ? "cursor-grabbing shadow-l scale-105"
                        : "cursor-grab shadow-l"
                    } ${isResizing ? "shadow-l" : ""} select-none`}
                    style={getCropStyle()}
                  ...
                  >
                    ...
                    <div className="absolute inset-0 pointer-events-none">
                      <div className="grid grid-cols-3 grid-rows-3 w-full h-full">
                        {[...Array(9)].map((_, i) => (
                          <div
                            key={i}
                            className="border border-blue-400/40 animate-pulse"
                          />
                        ))}
                      </div>
                    </div>

                    {/* Resize handles - larger on mobile for better touch interaction */}
                    <div
                      className={`resize-handle absolute -top-2 -left-2 ${
                        isMobile ? "w-10 h-10" : "w-5 h-5"
                      } bg-gradient-to-br from-blue-400 to-blue-600 border-2 border-white rounded-full cursor-nwse-resize select-none`}
                    ...
                    />
                    <div
                      className={`resize-handle absolute -top-2 -right-2 ${
                        isMobile ? "w-10 h-10" : "w-5 h-5"
                      } bg-gradient-to-br from-blue-400 to-blue-600 border-2 border-white rounded-full cursor-nesw-resize select-none`}
                    ...
                    />
                    <div
                      className={`resize-handle absolute -bottom-2 -left-2 ${
                        isMobile ? "w-10 h-10" : "w-5 h-5"
                      } bg-gradient-to-br from-blue-400 to-blue-600 border-2 border-white rounded-full cursor-nesw-resize shadow-l select-none`}
                    ...
                    />
                    <div
                      className={`resize-handle absolute -bottom-2 -right-2 ${
                        isMobile ? "w-10 h-10" : "w-5 h-5"
                      } bg-gradient-to-br from-blue-400 to-blue-600 border-2 border-white rounded-full cursor-nwse-resize shadow-l select-none`}
                    ...
                    {!isMobile && (
                      <>
                        <div
                          className="resize-handle absolute -top-2 left-1/2 transform -translate-x-1/2 w-6 h-4 bg-gradient-to-b from-blue-400 to-blue-600 border-2 border-white rounded-full cursor-n-resize shadow-l hover:shadow-l hover:scale-110 select-none"
                        ...
                        />
                        <div
                          className="resize-handle absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-6 h-4 bg-gradient-to-t from-blue-400 to-blue-600 border-2 border-white rounded-full cursor-s-resize shadow-l hover:shadow-l hover:scale-110 select-none"
                        ...
                        />
                        <div
                          className="resize-handle absolute -left-2 top-1/2 transform -translate-y-1/2 w-4 h-6 bg-gradient-to-r from-blue-400 to-blue-600 border-2 border-white rounded-full cursor-w-resize shadow-lg hover:shadow-l hover:scale-110 select-none"
                        ...
                        />
                        <div
                          className="resize-handle absolute -right-2 top-1/2 transform -translate-y-1/2 w-4 h-6 bg-gradient-to-l from-blue-400 to-blue-600 border-2 border-white rounded-full cursor-e-resize shadow-l hover:shadow-l hover:scale-110 select-none"
                    ...
                    <div
                      className={`absolute ${
                        isMobile
                          ...
                          : "-top-12 left-0"
                      } bg-gradient-to-r from-gray-800 to-gray-900 text-white text-sm px-3 py-2 rounded-lg shadow-l border border-gray-700 backdrop-blur-sm z-10 select-none`}
                    >
              ...
              <div className="text-center text-gray-600 max-w-md mx-auto p-4 sm:p-8">
                <div className="mb-6 sm:mb-8 relative">
                  <div className="relative">
                    <svg
                      className="w-16 h-16 sm:w-24 sm:h-24 mx-auto text-gray-300 animate-pulse"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
        ...
        <div className="hidden lg:flex lg:w-[200px] xl:w-[250px] bg-gradient-to-br from-white/80 via-gray-50/80 to-blue-50/80 backdrop-blur-sm border-l border-gray-200/50 items-center justify-center shadow-l relative overflow-hidden">
          ...
          <div className="relative text-center p-4 xl:p-6 bg-white/60 backdrop-blur-sm rounded-xl shadow-xl border border-white/30 hover:bg-white/80 transition-all duration-300 group">
            <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-300">
              <div className="w-12 h-12 xl:w-16 xl:h-16 bg-gradient-to-br from-green-400 to-emerald-500 rounded-l mx-auto flex items-center justify-center shadow-l">
                <span className="text-xl xl:text-2xl">📱</span>
              </div>
            </div>
            <div className="text-gray-700 text-xs xl:text-sm font-semibold mb-1">
              Premium Ad Space
            </div>
      ...
      <div className="w-full h-32 sm:h-40 lg:h-48 bg-gradient-to-r from-white/80 via-gray-50/80 to-purple-50/80 backdrop-blur-sm border-t border-gray-200/50 flex items-center justify-center shadow-l relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent"></div>
        <div className="relative text-center p-4 sm:p-6 lg:p-8 bg-white/60 backdrop-blur-sm rounded-xl lg:rounded-l shadow-l border border-white/30 hover:bg-white/80 transition-all duration-300 group">
          <div className="text-2xl sm:text-3xl lg:text-4xl mb-2 sm:mb-3 lg:mb-4 group-hover:scale-110 transition-transform duration-300">
            <div className="w-12 h-8 sm:w-16 sm:h-10 lg:w-20 lg:h-12 bg-gradient-to-br from-red-400 to-pink-500 rounded-xl lg:rounded-2xl mx-auto flex items-center justify-center shadow-l">
              <span className="text-lg sm:text-xl lg:text-2xl">🖥️</span>
            </div>
          </div>
          <div className="text-gray-700 text-xs sm:text-sm font-semibold mb-1">
